"""
Django settings for ganga_backend project.
...
SECRET_KEY = "django-insecure-2kmce3s6w3-pw=#0j^0uxlwxjx(@nqcknpe^wu5mj4dzp@qp!p"
...
ROOT_URLCONF = "ganga_backend.urls"
...
# WhiteNoise — serve the built React app at the site root
